...
function parseComponents( results, tmpl, renderers ){
...
function mapComponents( componentsDirectory, tmpl, renderers ){
    return new Promise(
        ( resolve, reject ) => Promise
            .all( [
            ...
            .then(
                ( results ) => resolve(
                    parseComponents( results, tmpl, renderers )
                )
            )
            .catch( reject )
    );
...
module.exports = function renderComponents( componentsDirectory, renderers ){
